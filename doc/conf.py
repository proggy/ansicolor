...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.doctest', 'sphinx.ext.intersphinx', 'sphinx.ext.todo', 'sphinx.ext.mathjax', 'numpydoc']
...
texinfo_documents = [
  ('index', 'ansicolor', u'ansicolor Documentation',
   u'Daniel Jung', 'ansicolor', 'One line description of project.',
   'Miscellaneous'),
]
